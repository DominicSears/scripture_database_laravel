<div class="w-full flex flex-row px-2 items-center max-w-3xl" x-data="{
    ...
    <button wire:click="submit" class="px-2 py-4 h-full bg-blue-500 text-white rounded-tr-lg rounded-br-lg">
